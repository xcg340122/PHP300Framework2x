...
class App{
	...
	*/
	...
	public function run(){
        ...
        $Info = $this->get('Running')->TotalInfo();

		//print_r($Info);
		echo '<br />';
		echo 'Framework RunTime: '.round($Info['endTime'] - $Info['startTime'], 3).' S';
		echo '<br />';
		echo 'Framework Memory: '.($Info['endRam'] - $Info['startRam']) .' byte';echo '<br />';
	}
}