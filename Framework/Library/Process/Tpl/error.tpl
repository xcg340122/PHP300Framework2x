...
<style type="text/css">
    <?php
    require "{$staticPath}css/bootstrap.min.css";
    require "{$staticPath}css/zenburn.min.css";
    ?>
</style>
<script  type="text/javascript">
<?php require "{$staticPath}js/jquery.min.js";require "{$staticPath}js/bootstrap.min.js";require "{$staticPath}js/highlight.min.js";?>
</script>
<body>
